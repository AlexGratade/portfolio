...
<main>
    <h1>Contactez-moi</h1>
    <p>N'hésitez pas à me contacter via ce formulaire. Je répondrai dès que possible.</p>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!empty($nom) && !empty($email) && !empty($sujet) && !empty($message)) {
            if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                $to = "gratade.alexandre1@gmail.com"; // Remplacez par votre email
                ...
                if (mail($to, $subject, $body, $headers)) {
                    ...
                    echo "<p style='color: red;'>Une erreur est survenue lors de l'envoi de votre message. Veuillez réessayer plus tard.</p>";
                }
            } else {
